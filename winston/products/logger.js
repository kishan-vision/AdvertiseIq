...
const FOLDER_PATH = path.join(__dirname, "../../logs/products");
...
const logger = winston.createLogger({
  ...
  transports: [
    new Console(),
    new File({ filename: `${FOLDER_PATH}/${currentDate}.txt` }),
  ],
});

function product_write_logs({
  message = null,
...
module.exports = { logger: logger, product_write_logs: product_write_logs };
