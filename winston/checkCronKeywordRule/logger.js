...
const FOLDER_PATH = path.join(__dirname, "../../logs/checkCronRule");
...
function extra_write_logs({
  ...
  try {
    let log_data_list = [];
    log_data_list.push(`current_time: ${current_time}`);
    ...
    console.error("An error occurred while writing logs:", error);
  }
}

module.exports = {
  logger: logger,
  extra_write_logs: extra_write_logs,
};
